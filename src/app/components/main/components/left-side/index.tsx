	...
	return (
		<div className='flex flex-col items-center lg:items-start gap-6 w-full lg:w-[50%]'>
			<h1 className='text-[#2b2624] text-center lg:text-left text-[26px] lg:text-[46px] font-extrabold leading-tight'>
				Turkmenistanda Iň Uly Sement Zawody
			</h1>
			...
			<p className='text-[16px] text-gray-700 text-center lg:text-left max-w-xl leading-relaxed'>
				35+ years engineering corrosion-resistant equipment that keeps SAP
				plants running efficiently. Trusted by 200+ plants worldwide for
				critical acid handling solutions.
			</p>

			<div className='flex flex-col lg:flex-row items-center gap-4 w-full mt-4'>
				<Button
					title='About Us'
			...
			<div className='grid grid-cols-3 gap-6 mt-12 w-full'>
				<div className='flex flex-col items-center lg:items-start gap-1'>
					<p className='text-[#2b2624] font-extrabold text-[28px]'>200+</p>
					<p className='text-gray-600 text-sm'>Sold Products</p>
				</div>
				<div className='flex flex-col items-center lg:items-start gap-1'>
					<p className='text-[#2b2624] font-extrabold text-[28px]'>10+</p>
					<p className='text-gray-600 text-sm'>Years of Service</p>
				</div>
				<div className='flex flex-col items-center lg:items-start gap-1'>
					<p className='text-[#2b2624] font-extrabold text-[28px]'>15+</p>
